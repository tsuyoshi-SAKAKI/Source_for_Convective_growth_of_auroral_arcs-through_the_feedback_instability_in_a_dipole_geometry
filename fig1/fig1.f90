program kenkyuu
 ...
 x0  = (dsin(pi/9.d0))**2.d0   
 mu0 = -dcos(pi/9.d0) / dsqrt(1.d0 - x0) 
 lx  = -(dsin(pi/9.d0 - bound))**2.d0 +(dsin(pi/9.d0 + bound))**2.d0 
 lz  = -dlog(alp * mu0 + dsqrt(1.d0 + (alp * mu0)**2.d0)) / ifalp  
